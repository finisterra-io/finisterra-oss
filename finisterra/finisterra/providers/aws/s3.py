...
class S3:
    ...
    def aws_s3_bucket(self, selected_s3_bucket=None, ftstack=None):
        ...
        for bucket in all_buckets:
            ...
            try:
                ...
                if bucket_region == self.provider_instance.aws_region:
    ...
    def process_single_s3_bucket(self, bucket_name, ftstack=None):
        ...
        # Skip processing if the bucket's region does not match self.provider_instance.aws_region
        if bucket_region != self.provider_instance.aws_region:
            logger.debug(
        ...
        if "gov" not in self.provider_instance.aws_region:
